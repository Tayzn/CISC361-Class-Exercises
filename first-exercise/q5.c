...
void* worker_sum(void* arg)
{
    ...
    startpart = (current_thread_data->thread_number - 1) * (MAX_NO_OF_ELEMENTS/MAX_NO_OF_THREADS);
    endpart = current_thread_data->thread_number * (MAX_NO_OF_ELEMENTS/MAX_NO_OF_THREADS);
